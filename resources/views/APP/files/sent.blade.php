<x-app-layout>
    ...
    <div class="py-12">
        <a href="{{ route('files.create') }}" class="bg-blue-500 text-black px-4 py-2 rounded hover:bg-green-600">Add new</a>
    <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
        ...
        <td class="py-3 px-6">
            <a href="{{ route('files.show',$file) }}" class="bg-blue-500 text-black px-4 py-2 rounded hover:bg-green-600">View</a>
        </tr>
         @endforeach
        </tbody>
    </table>
